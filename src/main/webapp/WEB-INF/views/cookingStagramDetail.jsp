...
<head>
    ...
    <link rel="stylesheet" href="resources/css/cookingStagramDetail.css">
</head>
        ...
        <div class="main">
            <div class="board-container">
                ...
                <div class="comment-container">
                    <span style="font-size: large; margin-left: 10px;">comment</span> 
                    <div class="comment-wrap">
                        <div class="comment-profile-image"></div>
                        <div class="comment-nickname"><span>댓글 작성자 닉네임</span></div>
