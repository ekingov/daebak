<%@ page language="java" contentType="text/html; charset=UTF-8"
    ...
    <head>
        ...
        <link rel="stylesheet" href="/webapp/resources/css/basic.css">
        <link rel="stylesheet" href="/webapp/resources/css/basicMedia.css">
    ...
    <body>
        <div class="page">
                ...
                <ul class="header-menu header-item">
                    ...
                    <li class="header-menu-item">
                        <a href="" class="header-menu-link">
                            <svg class="header-menu-icon" viewBox="0 0 15 15" fill="none"
            ...
            <div class="loginform">
                <div class="login">
                    <button id="log-tab">로그인</button>
                    <button id="log-tab">회원가입</button>
                </div>
    
                <div class="id-passward">
                    <input id="ip" type="text" placeholder="아이디" onfocus="this.placeholder=''"onblur="this.placeholder='아이디'">
                    <input id="ip" type="password" placeholder="비밀번호" onfocus="this.placeholder=''"onblur="this.placeholder='비밀번호'">
                    <p id="remember">아이디 기억하기 <input type="checkbox"></p>
                    <input id="loginbut" type="button" value="로그인">
                    <p id="forgot">아이디/비밀번호 찾기</p>
                </div>  
            </div>
