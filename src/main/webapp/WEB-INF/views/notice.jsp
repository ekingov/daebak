                ...
                <div class="notice-container">
                    ...
                    <div class="notice">
                        <table class="table">
                            ...
                            <tr>
                                <td>8</td>
                                <td class="title"><a href="detail.html">스프링 8강까지의 예제 코드</a></td>
                                <td>newlec</td>
                                <td>
                                    2019-08-18		
                                </td>
                            ...
                            <tr>
                                <td>7</td>
                                <td class="title"><a href="detail.html">스프링 DI 예제 코드</a></td>
                                <td>newlec</td>
                                <td>
                                    2019-08-15		
                                </td>
                            ...
                            <tr>
                                <td>6</td>
                                <td class="title"><a href="detail.html">뉴렉쌤 9월 초 국기과정 모집 안내</a></td>
                                <td>newlec</td>
                                <td>
                                    2019-06-11		
                                </td>
                            ...
                            <tr>
                                <td>5</td>
                                <td class="title"><a href="detail.html">뉴렉처 강의 수강 방식 안내</a></td>
                                <td>newlec</td>
                                <td>
                                    2019-05-24		
                                </td>
                            ...
                            <tr>
                                <td>4</td>
                                <td class="title"><a href="detail.html">자바 구조적인 프로그래밍 강의 예제 파일</a></td>
                                <td>newlec</td>
                                <td>
                                    2019-04-24		
                                </td>
                    ...
                    <div class="indexer">
                        <div><span class="">1</span> / 1 pages</div>
                    </div>
                    ...
                    <div class="pager">	
                        ...
                        <ul class="-list-">
                            <li><a class="-text-" href="?p=1&t=&q=" >1</a></li>
                        </ul>
                        <div>
