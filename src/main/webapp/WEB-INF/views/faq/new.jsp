            ...
            <form action="/faq/register" method="post">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="title" name="title" size="63" placeholder="제목을 입력하세요" required></td>
                    </tr>

                    <tr>
                        <td><label for="writer">작성자</label></td>
                        <td><input type="text" id="writer" name="writer" size="8" placeholder="작성자" required></td>
                    </tr>
            
                    <tr>
                        <td><label for="content">내용</label></td>
                        <td><textarea name="content" id="content" cols="65" rows="10" placeholder="내용을 입력하세요" required></textarea></td>
                    </tr>
