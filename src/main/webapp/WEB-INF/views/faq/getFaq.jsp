            ...
            <form action="/faq/register" method="post">
                <table>
                    <tr>
                        ...
                        <td><input type="text" id="title" name="title" size="63" value="${faq.title}" readonly></td>
                    </tr>
            
                    <tr>
                        <td><label for="content">내용</label></td>
                        <td><textarea name="content" id="content" cols="65" rows="10" readonly>${faq.content}</textarea></td>
                    </tr>
