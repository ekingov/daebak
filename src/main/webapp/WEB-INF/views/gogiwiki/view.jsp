...
<head>
    ...
    <link rel="stylesheet" href="/resources/css/gogiwiki.css">
...
<body>
    ...
    <div class="page">
        ...
        <div class="main"> 
                <p class="main-title">고기위키</p>
                <div class="wiki-container">
                    <div class="gogi-kind">
                        <div class="kind">
                            <label for="cow"></label>
                            <input type="button" class="kind-button" id="cow" name="cow" value="cow"></input>
                            <label for="pig"></label>
                            <input type="button" class="kind-button" id="pig" name="pig" value="pig"></input>
                        </div>
                        <div class="kind-image" id="kind-image"></div>
                    </div>
                    <div>
                        <div class="kind-detail" id="kind-detail"></div>
                    </div>
                </div>
        </div>
    ...
    <script src="/resources/js/changeGogiPage.js"></script>
